...
$(function(){
	...
	$( "td.updateTran:contains('배송하기')" ).on("click" , function() {
		//Debug..
		//alert(  $(this).html().trim() );
		var num1 = $(this).html().trim().split('"');
		var tranNo = num1[1];
		var prodNo = num1[3];
	 	alert(num1[1]);
	 	alert(num1[3]);
	 	self.location ="/purchase/updateTranCode?prodNo="+prodNo+"&tranNo="+tranNo;
	});
	...
	if( menu == 'search'){
		...
		$("td.kod:nth-child(9n+3)").on("click", function(){
			...
			prod9 = prod7.concat(prod8);
			//alert(prod9);
			self.location ="/product/updateProduct?prodNo="+prod9+"&menu=manage";
		});
	};
});	
